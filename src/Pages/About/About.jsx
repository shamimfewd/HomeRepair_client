        ...
        <div className="my-24 gap-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 md:p-4 p-2">
          ...
          <div>
            ...
            <h3 className="text-2xl tracking-wider">
              Textile Wonders Weaving Stories of Fashion, Quality, and
              Creativity!
            </h3>
            <hr />
            <p className=" tracking-wider mt-6">
              Step into a realm where threads intertwine to create tales of
              style and sophistication. Our textile wonders showcase a symphony
              of craftsmanship, blending quality materials with boundless
              creativity. Explore a world where every fabric tells a story,
              weaving narratives of fashion, elegance, and timeless allure.
            </p>
